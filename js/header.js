...
let header = '<div class = "logo-header"><img src="./img/logo.png" alt=""><p>Parqueo SCL</p></div> <nav><ul><li>Automóvil| 🚗</li><li>Autobúses| 🚌</li><li>Motocicleta| 🏍</li><li>Camionetas| 🚛</li><li>Otros| 🚲</li></ul></nav><div></div>';
